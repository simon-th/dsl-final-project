...
if __name__=="__main__":
  ...
  parser.add_argument('--evalpretrained', action='store_true', help='evaluate each pretrained agent against itself and other pretrained agents (may not be used with --benchmark)', default=False)
  ...
  obs_noise_dir = zoo_dir / "obs_noise"
  # Example:
  ...
  test_agents = {
      "ppo_obs_noise": PPOPolicy(obs_noise_dir / "ppo.zip"),
      "ppo_sp_obs_noise": PPOPolicy(obs_noise_dir / "ppo_sp.zip"),
      "ga_sp_obs_noise": makeSlimePolicyLite(obs_noise_dir / "ga_sp.json"),
  }
