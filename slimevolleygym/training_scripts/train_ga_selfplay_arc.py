...
from library.arc_wrapper import ArcWrapper
...
args = util.get_args('ga_selfplay_arc', '../zoo/ga_sp/ga.json')
LOGDIR = args.logdir
...
# Set the population around the best model params with a little noise
...
env = ArcWrapper(gym.make("SlimeVolley-v0"))
