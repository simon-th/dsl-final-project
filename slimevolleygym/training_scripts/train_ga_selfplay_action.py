...
from library.action_wrapper import RandomNoiseActionWrapper
...
args = util.get_args('ga_selfplay_action', '../zoo/ga/_sp/ga.json')
LOGDIR = args.logdir
...
env = RandomNoiseActionWrapper(gym.make("SlimeVolley-v0"))
